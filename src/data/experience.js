const experience = [
  {
    ...
    achievements: [
      'Lead development of e-commerce platform for collectibles and entertainment products',
      'Architect and implement microservices using React, TypeScript, and modern JavaScript frameworks',
      'Collaborate with cross-functional teams to deliver high-performance web applications',
      'Optimize application performance and user experience for global collectibles platform',
  ...
  },
  {
    ...
    achievements: [
      'Developed enterprise-scale e-commerce solutions serving millions of customers',
      'Built responsive web applications using React, Node.js, and cloud infrastructure',
